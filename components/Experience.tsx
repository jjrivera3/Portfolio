  ...
  return (
    <>
      <div className=" border-neutral-900 pb-4 mt-[150px]">
        <h2 className="mobile-header text-4xl md:text-5xl font-bold mt-20 text-gradient text-purple text-center mb-20 uppercase">
        ...
        <TracingBeam className="px-4">
          {experiences.map((experience, index) => (
            <div
              key={index}
              className="mb-8 flex flex-wrap lg:justify-center mobile-padding-left"
            >
