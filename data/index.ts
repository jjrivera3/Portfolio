...
export const projects = [
  ...
  },
  {
    id: 12,
    title: "Devbolt.io",
    des: "I assisted in developing an interactive learning platform, focusing on enhancing user experience and interface design. I contributed to migrating the backend from Strapi to a custom Node.js solution powered by Prisma for improved flexibility and scalability. I implemented unit and integration tests using Jest and React Testing Library to ensure reliability and maintainability of the platform.",
    img: "/p12.webp",
    iconLists: [
      "/re.svg",
      "/ts.svg",
  ...
  },
  {
    ...
    des: "I created an interactive clone of the iPhone 15 marketing site to highlight Apple’s innovative design and smooth animations. Using GSAP and Three.js, I built immersive 3D views, dynamic video content, and sleek transitions that reflect Apple’s polished aesthetic. This project allowed me to deepen my skills in modern web development and create a visually engaging user experience.",
    img: "/p11.webp",
    iconLists: ["/re.svg", "/tail.svg", "gsap.png", "/three.png"],
    link: "https://i-phone-website-swart.vercel.app/",
  },
  {
    id: 3,
    title: "Kumulus",
